...
class Application(Base):
    ...
    facebook_display_name = Column(String)
    ...
    call_driver_by_ats = Column(Boolean)
    ...
    show_tariffs_with_group_only = Column(Boolean)

    allow_choose_tariff = Column(Boolean)
    allow_change_passenger = Column(Boolean)
    allow_filter_model = Column(Boolean)
    allow_route_line = Column(Boolean)
    ...
    use_payment_type_in_panel = Column(Boolean)
    ...
    def __init__(self,
                 ...
                 use_photo='', photo_type='', bundle_ios='', google_map_ios='', facebook_app_id='', facebook_display_name='',
                 use_calls='', use_calls_office='', use_calls_driver='', call_driver_by_ats='',
                 ...
                 allow_choose_tariff='', allow_change_passenger='', allow_filter_model='', allow_route_line='',
                 show_tariffs_with_group_only='',
                 ...
                 use_payment_personal='', show_company_balance='', use_payment_type_in_panel=''):
        ...
        self.facebook_display_name = facebook_display_name
        ...
        self.call_driver_by_ats = call_driver_by_ats
        ...
        self.show_tariffs_with_group_only = show_tariffs_with_group_only
        ...
        self.allow_choose_tariff = allow_choose_tariff
        self.allow_change_passenger = allow_change_passenger
        self.allow_filter_model = allow_filter_model
        self.allow_route_line = allow_route_line
        ...
        self.use_payment_type_in_panel = use_payment_type_in_panel
