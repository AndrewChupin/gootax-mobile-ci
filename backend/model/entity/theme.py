...
class Theme(Base):
    ...
    accent_bg_tariff = Column(String)
    color_background_button_inner = Column(String)
    color_text_button_inner = Column(String)
    ...
    def __init__(self, hash='', splash_bg='', accent_bg='', accent_text='', menu_bg='', menu_text='', menu_stroke='',
                 ...
                 color_background_button_inner='', color_text_button_inner=''):
        self.hash = hash
        ...
        self.color_background_button_inner = color_background_button_inner
        self.color_text_button_inner = color_text_button_inner
