...
VALIDATE_FIELDS = ['app_name', 'app_id', 'bundle', 'api_key', 'push_key', 'google_map', 'metrica_key', 'autocomplete',
                   ...
                   'shown_client_id', 'use_review_detail', 'show_tariffs_with_group_only',
...
def parse_app_by_json(app: dict) -> Application:
    ...
    facebook_app_id = validate_field(parsed_json['facebook_app_id'])
    facebook_display_name = validate_field(parsed_json['facebook_display_name'])
    ...
    call_driver_by_ats = validate_field(parsed_json['call_driver_by_ats'])
    ...
    allow_choose_tariff = validate_field(parsed_json['allow_choose_tariff'])
    allow_change_passenger = validate_field(parsed_json['allow_change_passenger'])
    allow_filter_model = validate_field(parsed_json['allow_filter_model'])
    allow_route_line = validate_field(parsed_json['allow_route_line'])
    show_tariffs_with_group_only = validate_field(parsed_json['show_tariffs_with_group_only'])
    ...
    use_payment_type_in_panel = validate_field(parsed_json['use_payment_type_in_panel'])
    ...
    return Application(app_name=app_name, app_id=app_id, app_sku=app_sku, bundle=bundle, api_key=api_key,
                       ...
                       use_photo=use_photo, photo_type=photo_type, facebook_app_id=facebook_app_id, facebook_display_name=facebook_display_name,

                       use_calls=use_calls, use_calls_office=use_calls_office, use_calls_driver=use_calls_driver, call_driver_by_ats=call_driver_by_ats,
                       ...
                       is_let_reject_after_assigned=is_let_reject_after_assigned, allow_choose_tariff=allow_choose_tariff,
                       allow_change_passenger=allow_change_passenger, allow_filter_model=allow_filter_model, allow_route_line=allow_route_line,
                       show_tariffs_with_group_only=show_tariffs_with_group_only,
                       ...
                       use_payment_type_in_panel=use_payment_type_in_panel)
...
def generate_app_json(form, hash_theme: str) -> dict:
    ...
    result = {
        ...
        "facebook_display_name": form["facebook_display_name"],
        ...
        "call_driver_by_ats": obj_to_bool(form["call_driver_by_ats"]),
        ...
        "show_tariffs_with_group_only": obj_to_bool(form["show_tariffs_with_group_only"]),

        "allow_choose_tariff": obj_to_bool(form["allow_choose_tariff"]),
        "allow_change_passenger": obj_to_bool(form["allow_change_passenger"]),
        "allow_filter_model": obj_to_bool(form["allow_filter_model"]),
        "allow_route_line": obj_to_bool(form["allow_route_line"]),
        ...
        "use_payment_type_in_panel": obj_to_bool(form["use_payment_type_in_panel"])
    }
