...
USE_ADDRESS_DETAIL = "showButtonDetailAddress"
...
USE_PAYMENT_TYPE_IN_PANEL = "needCurrentPayment"
...
USE_ROUTE_LINE = "useRouteLine"
SHOW_TARIFFS_WITH_GROUP_ONLY = "showTariffsWithGroupOnly"
# Constant types
# Photo types
CAR_TYPE = "carPhoto"
...
USE_CHOOSE_TARIFF = "allowChooseTariff"
USE_CHANGE_PASSENGER = "allowChangePassenger"
USE_FILTER_MODEL = "allowFilterModel"
...
class IosConfigurator:
    ...
    def configure_calls(self, config):
        ...
        self.put_bool(CALL_DRIVER_BY_ATS, config.call_driver_by_ats)
    ...
    def configure_default(self, config):
        ...
        self.put_bool(USE_FILTER_MODEL, config.allow_filter_model)
        self.put_bool(USE_CHOOSE_TARIFF, config.allow_choose_tariff)
        self.put_bool(USE_CHANGE_PASSENGER, config.allow_change_passenger)
        self.put_bool(USE_ROUTE_LINE, config.allow_route_line)
        self.put_bool(SHOW_TARIFFS_WITH_GROUP_ONLY, config.show_tariffs_with_group_only)
    ...
    def configure_payment(self, config):
        ...
        self.put_bool(USE_PAYMENT_TYPE_IN_PANEL, config.use_payment_type_in_panel)
