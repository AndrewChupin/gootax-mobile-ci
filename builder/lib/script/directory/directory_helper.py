...
class DirectoryHelper:
    ...
    def replace_android_driver_bundle(self, bundle, is_new: bool):
        folder_path = "/com/ux/driver" if is_new else "/com/gootax/driver"
        def_path = merge(self.final_path, 'app/src/main/java' + folder_path)
        path = str(bundle).replace(".", "/")
        new_path = merge(self.final_path + "/app/src/main/java/", path)
        os.renames(def_path, new_path)
