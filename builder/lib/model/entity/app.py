...
class Application:
    ...
    def __init__(self,
                 id: int =0, app_name='', app_id='', app_sku='', bundle='', api_key='', push_key='', metrica_key='', theme='',
                 ...
                 use_courier_form='', allow_choose_tariff='', allow_change_passenger='', allow_filter_model='', allow_route_line='',
                 show_tariffs_with_group_only='',
                 use_payment_card='', use_payment_corp='', use_payment_cash='', use_payment_bonus='',
                 show_company_balance='', use_payment_personal='', use_payment_type_in_panel=''):
