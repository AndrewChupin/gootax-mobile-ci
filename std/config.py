...
from std.mail.mail import YANDEX_MAIL
...
ROOT_BUNDLE_DRIVER_NEW: str = 'com.ux.driver'
...
MAIL_TYPE: str = YANDEX_MAIL
MAIL_LOGIN: str = "" # TODO MAIL
MAIL_PASSWORD: str = "" # TODO PASSWORD
...
HOST: str = "192.168.1.96"  # TODO CHANGE HOST
BASE_URL: str = "http://" + HOST + ":5000"

DATA_URL: str = 'mysql://mobilebuilder:JneijSj39ZmnqkwSDew@mysql0.uat/mobilebuilder?charset=utf8'
...
ANDROID_DRIVER_NEW_REP: str = "https://mgootax_redmine@bitbucket.org/gootaxapp/app_android_driver_ver2.git"
ANDROID_DRIVER_NEW_FOLDER_NAME: str = "app_android_new_driver"
ANDROID_DRIVER_NEW_MASTER_PATH: str = merge(ROOT_PATH, ANDROID_DRIVER_NEW_FOLDER_NAME)
...
COUNTRY_LIST = ["", "-ru", "-kk", "-tr", "-fa", "-az", "-tk", "-uz", "-ka", "-sr", "-me", "-it", "-de", "-tg", "-ar", "-ky", "-bg", "-ko"]
COUNTRY_DRIVER_LIST = ["", "-uz", "-tk", "-sr", "-sr-rME", "-ru", "-ro", "-ka", "-ga", "-fi", "-fa", "-de", "-cs", "-az", "-ar"]
COUNTRY_DRIVER_NEW_LIST = ["", "-ru"]
...
REPOSITORIES: dict = {
    ...
    "android_driver_new": ANDROID_DRIVER_NEW_REP
}
...
MASTER_PATH: dict = {
    ...
    "android_driver_new": ANDROID_DRIVER_NEW_MASTER_PATH
}
